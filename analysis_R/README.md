...
- [2_daily_figures.R](2_daily_figures.R) — This script generates the daily-scale figures used in Kim et al. (2026). Script 1 must be executed before running this script.
...
- [4_monthly_figures.R](4_monthly_figures.R) — This script generates the monthly-scale figures used in Kim et al. (2026). Script 3 must be executed before running this script.
- [5_KGE_improve_map.R](5_KGE_improve_map.R) — This script generates the Map figures used in Kim et al. (2026). Script 2 and 4 must be executed before running this script.
